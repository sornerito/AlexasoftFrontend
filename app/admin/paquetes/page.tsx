    ...
    getWithAuth("http://localhost:8080/servicio/paquetes")
      ...
      .then((data) => {
        ...
        const processedData: Paquete[] = data.map(
          (item: {
            paquete: { idPaquete: any; nombre: any; descripcion: any; estado: any };
            ...
            servicios: item.servicios.map(servicio => servicio.nombre).join(", "),
          })
        );
        ...
        const nuevoEstado =
          ...
          setPaquetes((prevPaquete) =>
            prevPaquete.map((paquete) =>
              paquete.idPaquete === idPaquete ? { ...paquete, estado: nuevoEstado } : paquete
          )
        );
      } else {
                    ...
                    >
                      ...
                      item.estado == "Activo"  ? (
                        <Dropdown>
                          ...
                          >
                            <DropdownItem href={`/admin/paquetes/editar/${item.idPaquete}`}>
          ...
          {(onClose) => (
            <>
              ...
              <ModalBody className="text-center">
                <h1 className=" text-3xl">¿Desea cambiar el estado del paquete?</h1>
                <p>
                  Hacerlo inhabilitará a todos los usuarios que tengan este rol.
                </p>
              </ModalBody>
              <ModalFooter>
