          ...
          <form onSubmit={handleFormSubmit}>
            <div className="grid gap-3 sm:grid-cols-2">
              ...
              <Input
                ...
                errorMessage={
                  !validarCedula(cedula)
                    ? "La cédula solo puede contener números y debe ser entre 8 y 15 dígitos."
                    : ""
                }
              />
              <Input
              ...
              <Input
                ...
                errorMessage={
                  !validarTelefono(telefono)
                    ? "El teléfono solo puede contener números y debe ser de 10 dígitos."
                    : ""
                }
              />
              <Input
                ...
                errorMessage={
                  !validarContrasena()
                    ? "La contraseña debe tener entre 11 y 14 caracteres, y contener al menos una minúscula, una mayúscula, un número y un carácter especial."
                    : ""
                }
              />
            </div>
              ...
              {(onClose) => (
                <>
                  ...
                  <ModalBody className="text-center">
                    ...
                    <p>
                      El colaborador se creará con la información proporcionada.
                    </p>
                  </ModalBody>
                  <ModalFooter>
